...
def build_graph():
    ...
    graph.add_node("trial_critique",        node_trial_critique)
    graph.add_node("pipeline_regulatory",   node_pipeline_regulatory)
    graph.add_node("new_analytics",         node_new_analytics)
    graph.add_node("investment_recommendation", node_investment_recommendation)
    graph.add_node("investor_narrative",    node_investor_narrative)
    ...
    graph.add_edge("literature_synthesis", "trial_critique")
    graph.add_edge("trial_mapping",        "trial_critique")
    graph.add_edge("trial_critique",       "pipeline_regulatory")
    graph.add_edge("pipeline_regulatory",  "new_analytics")
    graph.add_edge("new_analytics",        "investment_recommendation")
    graph.add_edge("investment_recommendation", "investor_narrative")
    graph.add_edge("investor_narrative",   END)
